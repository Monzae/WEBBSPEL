...
public class Water : MonoBehaviour {
    ...
    {
        //Spawning our water
        SpawnWater(8.8f,3.2f,0.3f,-1.6f);
    }
    ...
    public void SpawnWater(float Left, float Width, float Top, float Bottom)
    {
        ...
        for (int i = 0; i < edgecount; i++)
        {
            ...
            colliders[i].transform.position = new Vector3(Left + Width * (i + 0.5f) / edgecount, Top - 0.0f, 0);
            colliders[i].transform.localScale = new Vector3(Width / edgecount, 0.15f, 1);
